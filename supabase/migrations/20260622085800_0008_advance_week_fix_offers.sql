/*
# Fix: Phase 7 of advance_week used a RECORD and invalid assignment syntax.

Replace `v_promo_for_offers RECORD` + the bogus `SELECT INTO v_promo_for_offers.id`
syntax with two scalar variables v_promo_offer_id uuid and v_promo_offer_tier int.
Recreate advance_week() with the corrected Phase 7.
*/
...
BEGIN
  ...
  -- Phase 7: Generate fight offers for player-managed fighters (FIX: scalar vars)
